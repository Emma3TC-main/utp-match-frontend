...
export const careers: CareerData[] = [
  ...
  },
  {
    ...
    description: 'Dirige empresas con visión estratégica y habilidades para coordinar equipos, finanzas y operaciones.',
    badge: 'Negocios',
    ...
    risks: ['Exposiciones frecuentes', 'Análisis financiero', 'Trabajo en equipo constante'],
    skills: ['Gestión', 'Finanzas', 'Liderazgo', 'Estrategia'],
    insight: 'Administración combina visión de negocio, personas y decisión práctica.',
    courses: [
      { id: 'admin-intro', name: 'Fundamentos de Administración', cycle: 'Ciclo 1', area: 'Gestión', intensityLabel: 'Media', explanation: 'Aprenderás cómo se estructura y coordina una organización.', impact: 'Te ayuda a entender decisiones de negocio desde el primer ciclo.', difficulty: ['Lectura: Media', 'Casos: Constantes', 'Exposición: Media'], skill: 'Analizar organizaciones' },
    ],
  },
  {
    id: 'marketing',
    ...
    modality: 'Presencial / Virtual',
    description: 'Conecta marcas con personas usando investigación, creatividad, datos y comunicación digital.',
    badge: 'Negocios',
    intensity: { mathematics: 40, programming: 25, management: 65, communication: 92, logic: 62 },
    match: 72,
    matchLabel: 'Medio',
    matchText: 'Buena opción si te gusta comunicar ideas, entender audiencias y crear estrategias.',
    ...
    insight: 'Marketing mezcla creatividad con evidencia para decidir cómo una marca debe actuar.',
    courses: [
      { id: 'marketing-intro', name: 'Introducción al Marketing', cycle: 'Ciclo 1', area: 'Comunicación', intensityLabel: 'Media', explanation: 'Verás cómo se analizan clientes, mercados y propuestas de valor.', impact: 'Te entrena para conectar ideas con necesidades reales.', difficulty: ['Creatividad: Alta', 'Investigación: Media', 'Trabajo grupal: Alto'], skill: 'Diseñar propuestas de valor' },
    ],
  },
  {
    id: 'civil',
    ...
    area: 'Ingeniería',
    modality: 'Presencial',
    description: 'Diseña y construye infraestructura con base matemática, criterio técnico y seguridad.',
    badge: 'Ingeniería',
    intensity: { mathematics: 88, programming: 30, management: 62, communication: 55, logic: 84 },
    match: 62,
    matchLabel: 'Medio',
    matchText: 'Puede encajar si te gustan estructuras, planos y resolver problemas físicos concretos.',
    ...
    insight: 'Civil pide disciplina técnica y gusto por construir soluciones visibles.',
    courses: [
      { id: 'civil-intro', name: 'Introducción a la Ingeniería Civil', cycle: 'Ciclo 1', area: 'Ingeniería', intensityLabel: 'Media', explanation: 'Conocerás el rol del ingeniero civil en obras e infraestructura.', impact: 'Te ayuda a visualizar proyectos reales desde temprano.', difficulty: ['Física: Media', 'Planos: Medio', 'Cálculo: Alto'], skill: 'Pensar infraestructura' },
    ],
  },
  {
    id: 'law',
    ...
    courses: [
      { id: 'law-intro', name: 'Introducción al Derecho', cycle: 'Ciclo 1', area: 'Legal', intensityLabel: 'Media', explanation: 'Aprenderás conceptos base del sistema jurídico y sus ramas.', impact: 'Te permite comprender cómo se ordenan normas y derechos.', difficulty: ['Lectura: Alta', 'Memoria: Media', 'Argumentación: Alta'], skill: 'Construir argumentos' },
    ],
  },
  {
    id: 'psychology',
    ...
    courses: [
      { id: 'psychology-intro', name: 'Bases de la Psicología', cycle: 'Ciclo 1', area: 'Salud', intensityLabel: 'Media', explanation: 'Explorarás teorías y conceptos iniciales del comportamiento humano.', impact: 'Te ayuda a conectar observación, evidencia y acompañamiento.', difficulty: ['Lectura: Alta', 'Escucha: Alta', 'Investigación: Media'], skill: 'Comprender conducta humana' },
    ],
  },
  {
    id: 'architecture',
    ...
    area: 'Tecnología y software',
    modality: 'Virtual',
    description: 'Diseña infraestructura lógica de sistemas robustos, escalables y conectados.',
    badge: 'Tecnología',
    intensity: { mathematics: 64, programming: 88, management: 58, communication: 52, logic: 91 },
    match: 89,
    matchLabel: 'Alto',
    matchText: 'Encaja si te gusta pensar sistemas grandes, ordenar tecnología y anticipar problemas.',
    ...
    insight: 'Arquitectura de Software exige ver el mapa completo, no solo una pieza del código.',
    courses: [
      { id: 'software-architecture', name: 'Fundamentos de Arquitectura', cycle: 'Ciclo 1', area: 'Software', intensityLabel: 'Alta', explanation: 'Aprenderás cómo se organizan sistemas y componentes digitales.', impact: 'Te prepara para diseñar soluciones que puedan crecer.', difficulty: ['Lógica: Alta', 'Programación: Alta', 'Documentación: Media'], skill: 'Diseñar sistemas escalables' },
    ],
  },
]
